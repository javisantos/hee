...
class Component extends HTMLElement {
  ...
  connectedCallback () {
    ...
    this.addEventListener('click', (e) => {
      if (!e.path[0].attributes['onclick']) return
      ...
      try {
        ...
        throw new Error(`The arguments of ${funcName} must be a valid Object`)
      }

      if (typeof this[funcName] === 'function') {
        this[funcName](...args.reverse())
      } else {
        throw new Error(`The function ${funcName} in not defined in your component.`)
      }
    })
  }
